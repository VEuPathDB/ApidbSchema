...
CREATE INDEX subjres_revix0 ON apidb.SubjectResult (subject, subject_result_id) ;
CREATE INDEX subjres_revix1 ON apidb.SubjectResult (protocol_app_node_id, subject_result_id) ;
