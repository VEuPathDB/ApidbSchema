...
CREATE INDEX ccn_revix1 ON apidb.ChrCopyNumber (na_sequence_id, chr_copy_number_id) ;
CREATE INDEX ccn_revix0 ON apidb.ChrCopyNumber (protocol_app_node_id, chr_copy_number_id) ;
...
CREATE INDEX gcn_revix0 ON apidb.GeneCopyNumber (na_feature_id, gene_copy_number_id) ;
CREATE INDEX gcn_revix1 ON apidb.GeneCopyNumber (PROTOCOL_APP_NODE_ID, GENE_COPY_NUMBER_ID) ;
