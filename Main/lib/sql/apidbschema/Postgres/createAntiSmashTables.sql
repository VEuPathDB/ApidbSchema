...
INSERT INTO core.TableInfo
  ...
  WHERE 'antiSmashCluster' NOT IN (SELECT name FROM core.TableInfo WHERE database_id = d.database_id)
;
...
INSERT INTO core.TableInfo
  ...
  FROM
    (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo) p,
    (SELECT database_id FROM core.DatabaseInfo WHERE name = 'ApiDB') d
  WHERE 'antiSmashFeature' NOT IN (SELECT name FROM core.TableInfo WHERE database_id = d.database_id)
;
...
INSERT INTO core.TableInfo
  ...
  FROM
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo) p,
       (SELECT database_id FROM core.DatabaseInfo WHERE name = 'ApiDB') d
  WHERE 'AntismashClusterFeature' NOT IN (SELECT name FROM core.TableInfo WHERE database_id = d.database_id)
;