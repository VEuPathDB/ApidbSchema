...
CREATE INDEX gfp_mod_idx ON apidb.GeneFeatureProduct (modification_date, gene_feature_product_id) ;
CREATE INDEX gfp_revfk_idx ON apidb.GeneFeatureProduct (external_database_release_id, gene_feature_product_id) ;
