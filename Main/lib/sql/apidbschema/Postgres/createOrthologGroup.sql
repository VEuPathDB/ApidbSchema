...
ALTER TABLE apidb.OrthomclTaxon
  ADD CONSTRAINT ot_fk1 FOREIGN KEY (parent_id) REFERENCES apidb.OrthomclTaxon (orthomcl_taxon_id);

CREATE INDEX OrthomclTaxon_revix
  ON apidb.OrthomclTaxon (parent_id, orthomcl_taxon_id);

ALTER TABLE apidb.OrthomclTaxon
  ADD CONSTRAINT ot_fk2 FOREIGN KEY (taxon_id) REFERENCES sres.Taxon (taxon_id);
