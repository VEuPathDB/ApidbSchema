...
CREATE INDEX lopitres_1 ON apidb.LopitResults (na_feature_id) ;
CREATE INDEX lopitres_2 ON apidb.LopitResults (protocol_app_node_id) ;
--CREATE INDEX apidb.lopitres_3 ON apidb.LopitResults (lopit_result_id) ;
